...
@section('title', 'Application - Step 2: Project Information')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <a href="/applicant/application/step1?id={{ $application->id }}" class="inline-flex items-center text-gray-500 hover:text-[#155386] transition group">
            ...
            Back to Step 1: Ownership Verification
        </a>
    </div>
    ...
    <div class="mb-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Step 2: Project Information</h2>
...
document.getElementById('project-info-form').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (data.success) {
            showSuccessModal('Project information saved! Redirecting to Step 3...');
            setTimeout(() => {
