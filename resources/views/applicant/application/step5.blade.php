...
@section('title', 'Application - Step 5: Review & Submit')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Back Button -->
    <div class="mb-8">
        <a href="/applicant/application/step4?id={{ $application->id }}" class="inline-flex items-center text-gray-500 hover:text-[#155386] transition group">
            ...
            Back to Step 4: Upload Documents
        </a>
    </div>
    ...
    <div class="mb-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Step 5: Review & Submit</h2>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <div class="w-8 h-8 bg-[#155386] text-white rounded-full flex items-center justify-center text-sm font-bold">5</div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <ul class="mt-2 text-sm text-blue-700 list-disc list-inside">
                                    <li>All accomplished forms (printed from Step 3)</li>
    ...
    function displayEmptyDocuments() {
        ...
        requiredContainer.innerHTML = `
            <div class="text-center py-8 text-gray-500 col-span-2">
                ...
                <p class="text-xs text-gray-400 mt-1">Please go back to Step 4 to upload your documents</p>
            </div>
        `;
