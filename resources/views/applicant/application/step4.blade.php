...
@section('title', 'Application - Step 4: Upload Documents')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Step 4: Upload Documents to Google Drive</h2>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8">
            ...
            <form id="documents-form" class="space-y-6">
                ...
                <div class="mt-8">
                    ...
                    <!-- Structural Design Analysis (OPTIONAL) -->
        ...
        <div class="p-6 pt-0 flex justify-between items-center">
            <a href="/applicant/application/step3?id={{ $application->id }}" 
...
<script>
    ...
    // Define all document fields - Required
    ...
    const optionalFields = [
        'structural_analysis_link',   // OPTIONAL - Structural Design Analysis
    ...
    async function saveAllDocumentLinks() {
        ...
        try {
            ...
            showSuccessModal('All documents saved successfully! Redirecting to Step 5...');
            
            const completeResponse = await fetch('/applicant/application/step4/complete', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrf(),
            ...
            setTimeout(() => {
                window.location.href = `/applicant/application/step5?id=${applicationId}`;
            }, 2000);
