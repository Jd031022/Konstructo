...
<div class="p-4 md:p-6 bg-gray-50 min-h-screen max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        ...
        <div class="mt-4 md:mt-0">
            <span class="text-sm bg-blue-50 text-blue-600 px-4 py-2 rounded-full flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Last login: {{ optional($user->profile)->last_login_at ? optional($user->profile)->last_login_at->format('M d, Y • h:i A') : 'First login' }}
            </span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <!-- Account Statistics Card - Modern Design -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-bold text-[#155386]">{{ \App\Models\User::count() }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Total Applications</span>
                        <span class="text-sm font-bold text-[#155386]">{{ \App\Models\ApplicationDocument::count() ?? 0 }}</span>
                    </div>
                </div>
                @else
                ...
                @if($user->role !== 'admin')
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <a href="/{{ $user->role }}/applications" class="text-sm text-[#155386] hover:text-[#40798C] font-medium flex items-center justify-between group">
        ...
        <div class="lg:col-span-3 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-[#155386] to-[#40798C] text-white flex justify-between items-center">
                    ...
                    <button onclick="openEditModal('personal')" class="text-white hover:text-gray-200 transition flex items-center gap-1 text-sm bg-white/20 px-3 py-1 rounded-lg hover:bg-white/30">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-[#155386] to-[#1F363D] text-white flex justify-between items-center">
                    ...
                    <button onclick="openEditModal('account')" class="text-white hover:text-gray-200 transition flex items-center gap-1 text-sm bg-white/20 px-3 py-1 rounded-lg hover:bg-white/30">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                        </svg>
                        Edit
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-[#40798C] to-[#1F363D] text-white flex justify-between items-center">
                    ...
                    <button onclick="openEditModal('contact')" class="text-white hover:text-gray-200 transition flex items-center gap-1 text-sm bg-white/20 px-3 py-1 rounded-lg hover:bg-white/30">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                        </svg>
                        Edit
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-[#1F363D] to-[#155386] text-white flex justify-between items-center">
                    ...
                    <button onclick="openEditModal('address')" class="text-white hover:text-gray-200 transition flex items-center gap-1 text-sm bg-white/20 px-3 py-1 rounded-lg hover:bg-white/30">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                        </svg>
                        Edit
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <button onclick="openEditModal('password')" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition text-sm shadow-sm">
                                Change Password
                            </button>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <button onclick="openEditModal('2fa')" class="px-4 py-2 {{ optional($user->profile)->two_factor_enabled ? 'bg-white border border-gray-300 text-gray-700 hover:bg-gray-50' : 'bg-[#155386] text-white hover:bg-[#40798C]' }} rounded-lg transition text-sm shadow-sm">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <button onclick="openEditModal('sessions')" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition text-sm shadow-sm">
                                Manage
                            </button>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                            ...
                            <button onclick="openEditModal('deactivate')" class="px-4 py-2 bg-white border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition text-sm">
                                Deactivate
                            </button>
                        </div>
...
<!-- Edit Profile Modal -->
<div id="edit-modal" class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full hidden z-50 px-4 py-8" style="backdrop-filter: blur(4px);">
