        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-sm text-gray-500">4/6 Completed</span>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-medium text-gray-700">Structural Plans (5 sets)</span>
                        </div>
                        <span class="text-xs text-green-600 font-medium">Uploaded</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-medium text-gray-500">Electrical Plans</span>
                        </div>
                        <span class="text-xs text-yellow-600 font-medium">Required</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-medium text-gray-500">Sanitary/Plumbing Plans</span>
                        </div>
                        <span class="text-xs text-yellow-600 font-medium">Required</span>
                    </div>
                </div>

                <!-- Upload Button (only shown if documents missing) -->
        ...
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <ul class="text-sm text-gray-600 list-disc list-inside space-y-1">
                    <li>Ensure all required documents are uploaded to avoid delays in processing</li>
